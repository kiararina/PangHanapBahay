...
$db['default']['username'] = 'u247011366_admin';
$db['default']['password'] = 'ki@ra-1234';
$db['default']['database'] = 'u247011366_phbdb';
$db['default']['dbdriver'] = 'mysql';
$db['default']['dbprefix'] = '';
$db['default']['pconnect'] = TRUE;
$db['default']['db_debug'] = FALSE; //Filename: core/Loader.php Line Number: 346
