<div id="detail-page" class="tenant-page content-wrapper">
  <div class="content">
		  ...
		  <ul>
			<?php
				...
				foreach ($likes as $l_row):  
					if($l_row['like_prop_id'] == $property->prop_id){
						$isLike = true;	} 
				endforeach; ?>
			<?php if($isLike == true){  echo '<li><a href="javascript:void(0)" onclick="unlike('.$property->prop_id.')">Unlike</a></li>';}?>
			<?php if($isLike == false){ echo '<li><a href="javascript:void(0)" onclick="like('.$property->prop_id.')">Like</a></li>';}?>
			<?php
				$isShortlist = false;
				foreach ($shortlists as $s_row):  
					if($s_row['shortl_prop_id'] == $property->prop_id){
						$isShortlist = true;	} 
				endforeach; ?>
			<?php if($isShortlist == false){  echo '<li><a href="javascript:void(0)" onclick="shortlist('.$property->prop_id.')">Add to Shortlist</a></li>';}?>
			<?php if($isShortlist == true){ echo '<li><a href="javascript:void(0)" onclick="unshortlist('.$property->prop_id.')">Remove from Shortlist</a></li>';}?>
			<li><a href="">comment</a></li>
			<li><a href="#inquiryModal">Inquiry</a></li>
			<li><a href="#picturesModal">Pictures</a></li>
			<li><a href="<?php echo base_url(); ?>pb_ctr_tenant/detail/<?php echo $property->prop_id; ?>">Details</a></li>
