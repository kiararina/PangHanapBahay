			...
			<div class="unit-wrapper">
				...
				<div class="options">
				  <ul>
					...
					<li><a href=""><?php echo($row['comments'] ==  0 ? 0: $row['comments']); ?> Comment(s)</a></li>
					<li><a href=""><?php echo($row['inquiry'] ==  0 ? 0: $row['inquiry']); ?> Inquiries</a></li>
					<li><a href="#locationModal<?php echo $div_counter; ?>">Location</a></li>
				  </ul>
				</div>
				<div id="picturesModal<?php echo $div_counter; ?>" class="modalDialog">
					<div>
						...
						<div id="more-photos">
						  <ul id="photo-controls">
							<li>
							  ...
							  <div id="photo1" class="delete-photo">
								<a href="">Delete</a>
							  </div>
							</li>
							<li>
							  ...
							  <div id="photo2" class="delete-photo">
								<a href="">Delete</a>
							  </div>				  
							</li>
							<li>
							  ...
							  <div id="photo3" class="delete-photo">
								<a href="">Delete</a>
							  </div>
							</li>
						  </ul>
				  ...
				  <div id="inquiryModal<?php echo $div_counter; ?>" class="modalDialog">
					<div>
					  <a href="#close" title="Close" class="close">X</a>
					  <h2>Inquiry</h2>
					  ...
					  <div class="form-wrapper">
						<form type="submit" name="unit-inquiry" action="index.html">
						  ...
						  <div class="modalbtn-area">
							<input id="send-btn" type="submit" value="" />
