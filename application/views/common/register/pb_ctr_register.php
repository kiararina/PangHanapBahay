	  ...
	  <div class="content">
	    <div class="left-content">
		 ...
		 <div>
		  <?php
			//flash messages
			if($this->session->flashdata('username_message')){
					echo '<strong><span style="color:#FF002A;">Username already taken!</span></strong>';
			}elseif($this->session->flashdata('email_message')){
			echo '<strong><span style="color:#FF002A;">Email already taken!</span></strong>';
