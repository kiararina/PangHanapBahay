		...
		if(typeof(this.options.data) != "undefined"){
			...
			$.each(this.options.data,function(){
				if(typeof(this.link) != "undefined"){ 
					...
					if(typeof(this.target) != "undefined"){ tmp.find('a').attr('target',this.target); }
				}else{
    ...
    $pc.fn.extend({
        ...
        build: function() {
       	...
       	//create the structure for pikachoose
			...
			this.finishAnimating({'source':this.active.attr('ref') || this.active.attr('src'),'caption':this.active.parents('li:first').find('span:first').html(), 'clickThrough':this.active.parent().attr('href') || "", 'clickThroughTitle':this.active.parent().attr('target') || ""});
        ...
        createThumb: function(ele) {
        	...
        	$.data(ele[0],'clickThroughTitle',self.parent('a').attr('target') || ""); //benjie
         ...
         */
	     ...
	     finishAnimating: function(data){
			...
			if(data.clickThrough != ""){
				...
				this.anchor.attr('target',data.clickThroughTitle);
			}else{
